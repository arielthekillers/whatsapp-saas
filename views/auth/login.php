...
<div class="min-h-screen flex flex-col items-center justify-center px-4 bg-gray-50">
  ...
  <div class="w-full max-w-sm bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
    <h1 class="text-2xl font-semibold mb-6 text-gray-800 text-center">Masuk ke Dashboard</h1>
    ...
    <form method="POST" action="<?= url('/login') ?>" class="space-y-4">
      ...
      <div>
        ...
        <input type="email" name="email" required placeholder="nama@email.com" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all">
      </div>
      <div>
        <label class="block text-sm font-semibold text-gray-600 mb-1">Password</label>
        <div class="relative">
          <input type="password" id="password" name="password" required placeholder="••••••••" class="w-full rounded-lg border border-gray-300 pl-3 pr-10 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all">
      ...
      <button type="submit" class="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-bold py-2.5 px-4 rounded-lg shadow-lg shadow-purple-500/20 transition-all hover:scale-[1.01]">Masuk</button>
    </form>

    <p class="text-sm text-gray-500 mt-6 text-center">Belum punya akun? <a href="<?= url('/register') ?>" class="text-purple-600 font-semibold hover:underline">Daftar</a></p>
  </div>
</div>
