...
<span class="json-key">$url</span> = <span class="json-string">'https://wapify.biz.id/v1/messages/send'</span>;
...
url = <span class="json-string">"https://wapify.biz.id/v1/messages/send"</span>
headers = {
    <span class="json-string">"Authorization"</span>: <span class="json-string">"Bearer YOUR_API_KEY"</span>,
    <span class="json-string">"Content-Type"</span>: <span class="json-string">"application/json"</span>
}
...
<pre>curl -X POST "https://wapify.biz.id/v1/messages/send" \
  ...
  -d <span class="json-string">'{
    ...
    <span class="json-key">"text"</span>: <span class="json-string">"Temukan promo spesial Anda hari ini 🚀"</span>
            ...
            <div id="img-php" class="tab-content hidden">
<pre><span class="json-key">&lt;?php</span>
<span class="json-key">$data</span> = [
    <span class="json-string">'session'</span> =&gt; <span class="json-string">'test'</span>,
    <span class="json-string">'to'</span>      =&gt; <span class="json-string">'081234567890'</span>,
...
<pre><span class="json-key">const</span> res = <span class="json-key">await</span> axios.post(<span class="json-string">'https://wapify.biz.id/v1/messages/send'</span>, {
  ...
  <span class="json-key">url</span>: <span class="json-string">'https://picsum.photos/600/400'</span>,
  <span class="json-key">text</span>: <span class="json-string">'Temukan promo spesial Anda hari ini 🚀'</span>
}, { <span class="json-key">headers</span>: { <span class="json-string">'Authorization'</span>: <span class="json-string">'Bearer YOUR_API_KEY'</span> } });</pre>
            </div>
          </div>
        </div>
...
<pre>curl -X POST "https://wapify.biz.id/v1/messages/send" \
  ...
  -d <span class="json-string">'{
    ...
    <span class="json-key">"text"</span>: <span class="json-string">"Video Panduan Penggunaan Aplikasi Wapify"</span>
            ...
            <div id="vid-php" class="tab-content hidden">
<pre><span class="json-key">&lt;?php</span>
<span class="json-key">$data</span> = [
    <span class="json-string">'session'</span> =&gt; <span class="json-string">'test'</span>,
    <span class="json-string">'to'</span>      =&gt; <span class="json-string">'081234567890'</span>,
...
echo <span class="json-key">$response</span>;</pre>
            ...
            <div id="check-node" class="tab-content hidden">
<pre><span class="json-key">const</span> axios = require(<span class="json-string">'axios'</span>);
        ...
        "item": [
            {
                ...
                "request": {
                    ...
                    "url": { "raw": "https://wapify.biz.id/v1/messages/send" }
                }
            },
            {
            ...
            {
                "name": "4. Daftar Sesi WhatsApp",
                "request": {
                    "method": "GET",
                    "header": [
                        { "key": "Authorization", "value": "Bearer {{API_KEY}}", "type": "text" }
                    ],
                    "url": { "raw": "https://wapify.biz.id/v1/sessions" }
                }
            }
        ]
    };
