...
<div class="min-h-screen flex flex-col md:flex-row">
  ...
  <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between p-6 shrink-0 hidden md:flex sticky top-0 h-screen">
    <div class="space-y-8">
      ...
      <div class="space-y-6">
        ...
        <!-- Group 3: Resources -->
        <div>
          <p class="text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-2.5 px-3">Resources &amp; Admin</p>
          <div class="space-y-1">
  ...
  <div id="mobile-menu" class="hidden bg-white border-b border-gray-200 px-6 py-4 space-y-3.5 md:hidden">
    ...
    <a href="<?= url('/admin') ?>" class="block text-sm font-semibold text-gray-600 hover:text-purple-600 font-bold text-purple-700">Admin Panel</a>
